...
export default function ChatSupportWidget() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      // Uncomment and configure for real backend
      // const backendUrl =
                ...
                <form onSubmit={handleSubmit} className="space-y-3">
                  ...
                  <div className="pt-2">
                    <p className="text-[10px] text-justify text-gray-600 mb-2 leading-tight">
                      By submitting, you authorize Podium to text/call the
                      number above possibly using automated means & AI-generated
                      calls/messages. Msg&data rates apply, msg frequency
                    ...
                    <div className="flex justify-center">
                      <button
                        type="submit"
                        className="bg-orange-600 hover:bg-orange-700 text-white rounded-lg py-2 px-6 text-sm font-bold transition-colors"
                      >
                        Send
                      </button>
                    </div>
              ...
              <div className="p-4 text-center flex-grow flex flex-col justify-between items-center overflow-y-auto">
                <>
                  ...
                  <p className="text-[10px] text-gray-500 mb-4 leading-tight">
                    ...
                    from Podium using the mobile number you provided on the
                    prior page, subject to those terms. Text REMOVE to opt out
